                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <form method="post"
                                        action="{{ isset($data->project_id) ? url('/admin/projects/' . $data->project_id) : url('/admin/projects') }}">
                                        @csrf
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="date" name="end_date"
                                                        id="{{ isset($data->end_date) ? '' : 'endDate' }}"
                                            ...
                                            <div class="col-lg-6 form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea rows="5" name="description" cols="5"
                                                        class="form-control @error('description') is-invalid @enderror" placeholder="Enter The Description ">{{ old('description', $data->description ?? '') }}</textarea>
                                                    @error('description')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                                        </div>
                                            ...
                                            <div class="col-lg-6 form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="organization"
                                                        ...
                                                        placeholder="Enter The Business / Company Name "
                                            ...
                                            <div class="col-lg-6 form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="amount"
                                                        ...
                                                        placeholder="Enter The Price Per Project"
