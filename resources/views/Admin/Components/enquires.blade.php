                                     ...
                                     <tbody>
                                         @forelse($paginatedData as $enquiry)
                                             <tr>
                                                 ...
                                                 <td>
                                                     <a type="button"
                                                         href="{{ url('/admin/enquiries/' . $enquiry->enquiry_id . '/view') }}"
                                                         class="btn btn-primary"><i class="ti-pencil-alt"></i>view
                                                     </a>
                                                     <form
                                                         action="{{ url('/admin/enquiries/' . $enquiry->enquiry_id) }}"
                                                         method="POST" style="display:inline;">
                                                         @csrf
                                                         @method('DELETE')
                                                         <button class="btn btn-danger"><i class="ti-trash"></i>Delete
                                                         </button>
                                                     </form>
                                                 </td>
                                             </tr>
