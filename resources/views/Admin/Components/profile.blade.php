                                                                    ...
                                                                    <div class="col-lg-6 form-group row">
                                                                        ...
                                                                        <div class="col-sm-9">
                                                                            <input type="text" name="first_name" class="form-control @error('first_name') is-invalid @enderror"
                                                                                placeholder="Enter The First Name" value="{{isset($data->first_name)? $data->first_name :''}}">
                                                                                @error('first_name')
                                                                    ...
                                                                    <div class="col-lg-6 form-group row">
                                                                        ...
                                                                        <div class="col-sm-9">
                                                                            <input type="text" name="last_name" class="form-control @error('last_name') is-invalid @enderror"
                                                                                placeholder="Enter The Last Name" value="{{isset($data->last_name)? $data->last_name :''}}">
                                                                                @error('last_name')
                                                                                    <div class="invalid-feedback">
                                                                                        {{ $message }}
                                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-6 form-group row">
                                                                        ...
                                                                        <div class="col-sm-9">
                                                                            <input type="email" name="email" class="form-control @error('email') is-invalid @enderror"
                                                                                placeholder="Enter The Email Address" value="{{isset($data->email)? $data->email :''}}">
                                                                                @error('email')
                                                                                    <div class="invalid-feedback">
                                                                                        {{ $message }}
                                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-6 form-group row">
                                                                        ...
                                                                        <div class="col-sm-9">
                                                                            <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror"
                                                                                placeholder="Enter The Phone Number" value="{{isset($data->phone)? $data->phone :''}}">
                                                                                @error('phone')
                                                                                    <div class="invalid-feedback">
                                                                                        {{ $message }}
                                                                                    </div>
