                                    ...
                                    <div class="page-body">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <form method='post' action="{{ isset($data->post_id) ? url('/admin/posts/' . $data->post_id) : url('/admin/posts') }}"
                                                                ...
                                                                <div class="col-lg-6 form-group row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        <input type="text" name="post_title" class="form-control @error('post_title') is-invalid @enderror"
                                                                            placeholder="Enter The Post Name" value="{{ old('post_title', $data->post_title ?? '') }}">
                                                                            @error('post_title')
                                                    ...
                                                    @enderror
                                                                ...
                                                                <div class="col-lg-12 form-group row">
                                                                    <label class="col-sm-2 col-form-label">Short
                                                                        Description</label>
                                                                    <div class="col-sm-10">
                                                                        <textarea rows="5" name="short_description" cols="5" class="form-control @error('short_description') is-invalid @enderror"
                                                                            placeholder="Enter The Review Message" >{{ old('short_description', $data->short_description ?? '') }}</textarea>
                                                                ...
                                                                <div class="col-lg-12 form-group row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <textarea rows="5" name="description" id="description" cols="5"
                                                                            ...
                                                                            placeholder="Enter The Review Message">{{ old('description', $data->description ?? '') }}</textarea>
                                                                            @error('description')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                                        </div>
                                                                ...
                                                                <div class="col-lg-12 form-group row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <select name="status" class="form-control @error('status') is-invalid @enderror">
                                                                            ...
                                                                            <option value="draft" {{ isset($data) && $data->status == 'draft' ? 'selected' : '' }}>
    Draft
</option>

<option value="published" {{ isset($data) && $data->status == 'published' ? 'selected' : '' }}>
    Published
</option>
                                                                        </select> 
                                                                        @error('status')
                                                                ...
                                                                <div class="col-lg-12 form-group row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        <input type="text" name="meta_title" class="form-control  @error('meta_title') is-invalid @enderror"
                                                                            placeholder="Enter The Meta Title" value="{{ old('meta_title', $data->postMeta->meta_title ?? '') }}">
                                                                            @error('meta_title')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                                        </div>
                                                                ...
                                                                <div class="col-lg-12 form-group row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        <textarea rows="5" name="meta_description" id="description" cols="5"
                                                                            ...
                                                                            placeholder="Enter The Meta Description">{{ old('meta_description', $data->postMeta->meta_description ?? '') }}</textarea>
                                                                ...
                                                                <div class="col-lg-12 form-group row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        <textarea rows="5" name="keywords" id="description" cols="5"
                                                                            ...
                                                                            placeholder="Enter The Meta Keywords">{{ old('keywords', $data->postMeta->keywords ?? '') }}</textarea>
                                                                            @error('keywords')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                                        </div>
