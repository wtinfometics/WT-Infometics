                                     ...
                                     <div class="card-block-small">
                                         ...
                                         <div>
                                             <span class="f-left m-t-10 text-muted">
                                                 <i class="text-c-blue f-16 icofont icofont-file m-r-10"></i>
                                                 Total Posts
                                             </span>
                                         </div>
                                     </div>
                             ...
                             <div class="col-md-6 col-xl-3">
                                 <div class="card widget-card-1">
                                     <div class="card-block-small">
                                         ...
                                         <div>
                                             <span class="f-left m-t-10 text-muted">
                                                 <i class="text-c-pink f-16 icofont icofont-briefcase m-r-10"></i>
                                                 Total Projects
                                             </span>
                                         </div>
                                     </div>
                             ...
                             <div class="col-md-6 col-xl-3">
                                 <div class="card widget-card-1">
                                     <div class="card-block-small">
                                         ...
                                         <div>
                                             <span class="f-left m-t-10 text-muted">
                                                 <i class="text-c-green f-16 icofont icofont-email m-r-10"></i>Total Enquiry
                                             </span>
                                         </div>
                                     </div>
                                 </div>
                             ...
                             <div class="col-md-6 col-xl-3">
                                 <div class="card widget-card-1">
                                     <div class="card-block-small">
                                         ...
                                         <div>
                                             <span class="f-left m-t-10 text-muted">
                                                 <i class="text-c-yellow f-16 icofont icofont-comment m-r-10"></i>Total
                                                 Testimonials
                                             </span>
                                         </div>
                                     </div>
